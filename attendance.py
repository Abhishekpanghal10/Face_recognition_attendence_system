...
class Attendance:
    def __init__(self, root):
        ...
        f_lbl.place(x=600, y=0,width=700,height=200)
        ...
        bg_img.place(x=0, y=200,width=1430, height=610)

        title_lbl=Label(bg_img, text="ATTENDANCE MANAGEMENT SYSTEM",font=("times new roman", 25, "bold"), bg="red",fg="white")
        title_lbl.place(x=0, y=0,width=1330,height=40)

        #main frame
        main_frame=Frame (bg_img, bd=2, bg="white")
        main_frame.place(x=10, y=40,width=1250,height=560)
        ...
        left_inside_frame.place(x=0, y=100,width=550,height=300)

        # label and entry

        # attendance id
        AttendanceId_label=Label(left_inside_frame, text="AttendanceID: ", font=("times new roman",13, "bold"))
        AttendanceId_label.grid(row=0, column=0, padx=2, pady=5, sticky=W)
        AttendanceID_entry=ttk.Entry(left_inside_frame, width=10,textvariable=self.var_atten_id, font=("times new roman",13, "bold"))
        AttendanceID_entry.grid(row=0, column=1, padx=10, pady=5, sticky=W)


        # roll|
        rollLabel=Label(left_inside_frame,text="Roll:",bg="white",font="comicsansns 11 bold")
        rollLabel.grid(row=0,column=2,padx=2, pady=5)

        atten_roll=ttk.Entry(left_inside_frame,width=10,textvariable=self.var_atten_roll, font="comicsansns 11 bold")
        atten_roll.grid(row=0,column=3, pady=5)

        #name
        nameLabel=Label(left_inside_frame, text="Name:",bg="white",font="comicsansns 11 bold")
        nameLabel. grid(row=1,column=0,padx=2, pady=5)

        atten_name=ttk.Entry(left_inside_frame,width=10,textvariable=self.var_atten_name, font="comicsansns 11 bold")
        ...
        atten_dep=ttk.Entry(left_inside_frame,width=10,textvariable=self.var_atten_dep, font="comicsansns 11 bold")
        atten_dep.grid(row=1,column=3, pady=8)

        # time
        timeLabel=Label(left_inside_frame,text="Time:",bg="white",font="comicsansns 11 bold")
        timeLabel. grid(row=2,column=0,padx=2, pady=5,)
        atten_time=ttk.Entry(left_inside_frame,width=10,textvariable=self.var_atten_time,font="comicsansns 11 bold")
        ...
        atten_date=ttk.Entry(left_inside_frame,width=10,textvariable=self.var_atten_date,font="comicsansns 11 bold")
        ...
        btn_frame.place(x=0, y=220,width=715, height=40)

        
        save_btn=Button(btn_frame, text="Import csv" ,command=self.importCsv,width=18, font=("times new roman", 10, "bold"),bg="blue", fg="white")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame, text="Export csv",command=self.exportCsv,width=18, font=("times new roman", 10, "bold"),bg="blue", fg="white")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame, text="Update" ,width=18, font=("times new roman", 10, "bold"),bg="blue", fg="white")
        delete_btn.grid(row=0,column=2)

        reset_btn=Button(btn_frame, text="Reset",width=18, font=("times new roman", 10, "bold"),bg="blue", fg="white")
        ...
        self .AttendaceReportTable.heading("department", text="Deaprtment")
    ...
    def importCsv(self):
        global mydata
        mydata.clear()
        f1n=filedialog.askopenfilename(initialdir=os.getcwd(),title="Open CSV",filetypes=(("CSV File","*.csv"),("ALl File", "*.*")),parent=self.root)
        with open(f1n) as myfile:
