...
class Student:
    def __init__(self, root):
        ...
        f_lbl.place(x=0, y=0,width=450,height=70)
        ...
        f_lbl.place(x=450, y=0,width=500,height=70)
        ...
        f_lbl.place(x=930, y=0,width=500,height=70)
        ...
        bg_img.place(x=0, y=70,width=1430, height=610)
        ...
        main_frame.place(x=20, y=40,width=1230,height=560)

        # left label frame
        Left_frame=LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE, text="Student Details", font=("times new roman", 12, "bold"))
        Left_frame.place(x=10, y=10,width=580, height=538)


        # current course information 
        current_course_frame=LabelFrame(Left_frame, bd=2, bg="white", relief=RIDGE, text="Current course information", font=("times new roman", 12, "bold"))
        current_course_frame.place(x=5, y=10,width=560, height=115)
        ...
        # course
        dep_label=Label(current_course_frame, text="Course",font=("times new roman", 12, "bold"))
        dep_label.grid(row=0 ,column=2,padx=10 ,sticky=W)

        dep_combo=ttk.Combobox(current_course_frame,textvariable=self.var_course, font=("times new roman", 12, "bold"),state="readonly",width=15)
        dep_combo["values"]=("select course", "FE","SE", "TE", "BSC")
        dep_combo.current(0)
        dep_combo.grid (row=0, column=3,padx=2 ,pady=10 ,sticky=W)

         # year
        dep_label=Label(current_course_frame, text="Year",font=("times new roman", 12, "bold"))
        dep_label.grid(row=1 ,column=0,padx=10 ,sticky=W)

        dep_combo=ttk.Combobox(current_course_frame,textvariable=self.var_year, font=("times new roman", 12, "bold"),state="readonly",width=15)
        ...
        dep_combo.grid (row=1, column=1,padx=2 ,pady=10 ,sticky=W)
         ...
         # semester
        dep_label=Label(current_course_frame, text="Semester",font=("times new roman", 12, "bold"))
        dep_label.grid(row=1 ,column=2,padx=10 ,sticky=W)

        dep_combo=ttk.Combobox(current_course_frame,textvariable=self.var_semester, font=("times new roman", 12, "bold"),state="readonly",width=15)
        ...
        class_Student_frame.place(x=5, y=125,width=560, height=500)
        ...
        studentID_entry=ttk.Entry(class_Student_frame,textvariable=self.var_std_id, width=10, font=("times new roman",13, "bold"))
        ...
        studentName_entry=ttk. Entry(class_Student_frame,textvariable=self.var_std_name, width=10, font=("times new roman", 13, "bold"))
        studentName_entry.grid(row=0, column=3, padx=10, pady=5, sticky=W)

        # class didvision
        class_div_label=Label(class_Student_frame, text="Class Division:",font=("times new roman", 10, "bold"))
        class_div_label.grid(row=1,column=0, padx=5, pady=5, sticky=W)
        
        div_combo=ttk.Combobox(class_Student_frame, textvariable=self.var_div, font=("times new roman",10,"bold"))
        ...
        roll_no_entry=ttk.Entry(class_Student_frame,textvariable=self.var_roll, width=10, font=("times new roman",13, "bold"))
        ...
        gender_combo=ttk.Combobox(class_Student_frame, textvariable=self.var_gender, font=("times new roman",10,"bold"))
        ...
        teacher_entry=ttk. Entry(class_Student_frame,textvariable=self.var_teacher, width=10, font=("times new roman",13, "bold"))
        ...
        delete_btn=Button (btn_frame, text="Delete",command=self.delete_data ,width=10, font=("times new roman", 10, "bold"),bg="blue", fg="white")
        delete_btn.grid(row=0,column=2)

        reset_btn=Button (btn_frame, text="Reset",command=self.reset_data,width=10, font=("times new roman", 10, "bold"),bg="blue", fg="white")
        reset_btn.grid(row=0,column=3)

        take_photo_btn=Button (btn_frame, text="Take photo",command=self.generate_dataset,width=10, font=("times new roman", 10, "bold"),bg="blue", fg="white")
        ...
        search_btn=Button(Search_frame, text="Search",width=14, font=("times new roman",13, "bold"),bg="blue")
        search_btn.grid (row=1, column=0)
        showAll_btn=Button(Search_frame, text="Show All",width=14, font=("times new roman", 13, "bold"),bg="blue")
        showAll_btn.grid(row=1, column=2)

        # ==== =========table frame ========
        table_frame=Frame (Right_frame, bd=2, bg="white", relief=RIDGE)
        table_frame.place(x=5, y=115 ,width=600, height=350)

        scroll_x=ttk.Scrollbar(table_frame, orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar (table_frame, orient=VERTICAL)

        self.student_table=ttk.Treeview(table_frame, column=("dep","course","year","sem","id","nname", "div", "roll", "gender", "dob", "email","gender","phone", "address", "teacher", "photo"),xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
        ...
        self.student_table.heading("nname",text="StudentName")
        ...
        self.student_table.column("nname",width=100)
    ...
    def add_data(self):
      if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
        ...
        try:
            conn=mysql.connector.connect(host="localhost", username="root", password="abpanghal@71",database="face_recognizer")
        ...
        try:
          ...
          while True:
              ...
              if face_cropped(my_frame) is not None:
                ...
                cv2.putText(face, str(img_id),(50,50), cv2.FONT_HERSHEY_COMPLEX, 5 ,(0,255,0),5)
